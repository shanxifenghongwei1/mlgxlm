...
var _goodsDetail = _interopRequireDefault(__webpack_require__(/*! ./pages/home/goods-detail/goods-detail.vue */ 216));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _goods_detail_vue_vue_type_template_id_a7b5d412___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./goods-detail.vue?vue&type=template&id=a7b5d412& */ 217);
/* harmony import */ var _goods_detail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./goods-detail.vue?vue&type=script&lang=js& */ 219);
...
/* harmony import */ var _goods_detail_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./goods-detail.vue?vue&type=style&index=0&lang=scss& */ 222);
...
__webpack_require__(/*! ./goods-detail.scss */ 221); //
//
//
//
//
...
//
//
var mySwiper = function mySwiper() {return __webpack_require__.e(/*! import() | components/mine/my-swiper */ "components/mine/my-swiper").then(__webpack_require__.bind(null, /*! @/components/mine/my-swiper.vue */ 765));};var evaluate = function evaluate() {return __webpack_require__.e(/*! import() | components/mine/evaluate */ "components/mine/evaluate").then(__webpack_require__.bind(null, /*! @/components/mine/evaluate.vue */ 592));};var topTit = function topTit() {return __webpack_require__.e(/*! import() | components/mine/top-title */ "components/mine/top-title").then(__webpack_require__.bind(null, /*! @/components/mine/top-title.vue */ 751));};var uniRate = function uniRate() {return __webpack_require__.e(/*! import() | components/uni-rate/uni-rate */ "components/uni-rate/uni-rate").then(__webpack_require__.bind(null, /*! @/components/uni-rate/uni-rate.vue */ 688));};var goodsList = function goodsList() {return __webpack_require__.e(/*! import() | components/mine/goods */ "components/mine/goods").then(__webpack_require__.bind(null, /*! @/components/mine/goods.vue */ 702));};var goodsNav = function goodsNav() {return __webpack_require__.e(/*! import() | components/uni-goods-nav/uni-goods-nav */ "components/uni-goods-nav/uni-goods-nav").then(__webpack_require__.bind(null, /*! @/components/uni-goods-nav/uni-goods-nav.vue */ 772));};var uniCountdown = function uniCountdown() {return __webpack_require__.e(/*! import() | components/uni-countdown/uni-countdown */ "components/uni-countdown/uni-countdown").then(__webpack_require__.bind(null, /*! @/components/uni-countdown/uni-countdown.vue */ 779));};var coll = function coll() {return __webpack_require__.e(/*! import() | components/mine/collect */ "components/mine/collect").then(__webpack_require__.bind(null, /*! @/components/mine/collect.vue */ 758));};var _default = { components: { mySwiper: mySwiper, evaluate: evaluate, topTit: topTit, uniRate: uniRate, goodsList: goodsList, goodsNav: goodsNav, uniCountdown: uniCountdown, coll: coll }, data: function data() {return { //前面页面数据 goods_id / goods_name
      options: {}, // goods详情
      good_detail: {}, // 图片地址
    ...
    finddetail: function finddetail() {var _this3 = this;var that = this;var data = {};data.goods_id = this.options.goods_id;console.log(data);this.global.request.post({ url: this.global.demao.api.goodsInfo, method: "GET", data: data, success: function success(res) {var a = [];res.goodsInfo.goods_planting_picture ? a = res.goodsInfo.goods_planting_picture.split(",") : a = [];if (a.length > 1) {a.pop();}res.goodsInfo.goods_planting_picture = a;var b = [];res.goodsInfo.goods_picture_detail ? b = res.goodsInfo.goods_picture_detail.split(",") : b = [];if (b.length > 1) {b.pop();}res.goodsInfo.goods_picture_detail = b;var c = new Date().getTime();var d = res.goodsInfo.limited_stop_time ? res.goodsInfo.limited_stop_time : c + 100000000;var f = _this3.formatDuring(d * 1000 - c);_this3.time = f;var num = 0;var g = res.seller;if (g) {g.forEach(function (v) {num += v.pt_sum;});}_this3.good_detail = res; //总拼团人数
          _this3.pt_num_all = num;_this3.com = { goods_id: res.goodsInfo.goods_id, shop_id: res.goodsInfo.shop_id, num: 1, is_cart: 0, good_cate: 0 // 参加了优惠券活动
                ...
                if (res.data.length) {_this3.cumpadd = res.data[0].is_use == 0 ? 1 : 2; //是否可以使用
                  _this3.coupon = res.data;} else {_this3.cumpadd = 0;}} });}if (_this3.good_detail.goodsInfo.promotion_type == 0 || _this3.good_detail.goodsInfo.promotion_type == 3) {_this3.buttonGroup = [{ id: 99, text: '加入购物车', backgroundColor: '#ff0000', color: '#fff' }, { id: 0, text: '立即购买', backgroundColor: '#ffa200', color: '#fff' }];} else if (_this3.good_detail.goodsInfo.promotion_type == 1) {_this3.buttonGroup = [{ id: 1, text: '拼团购买', backgroundColor: '#ff0000', color: '#fff' }, { id: 0, text: '立即购买', backgroundColor: '#ffa200', color: '#fff' }];} else if (_this3.good_detail.goodsInfo.promotion_type == 2) {_this3.buttonGroup = [{ id: 2, text: '优惠券购买', backgroundColor: '#ff0000', color: '#fff' }, { id: 0, text: '立即购买', backgroundColor: '#ffa200', color: '#fff' }];} else if (_this3.good_detail.goodsInfo.promotion_type == 4) {_this3.buttonGroup = [{ id: 3, text: '限时抢购买', backgroundColor: '#ff0000', color: '#fff' }, { id: 0, text: '立即购买', backgroundColor: '#ffa200', color: '#fff' }];}} });}, // 图文详情
