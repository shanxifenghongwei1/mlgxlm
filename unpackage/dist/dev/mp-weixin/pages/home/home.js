...
//
//
var goodlist = function goodlist() {return Promise.all(/*! import() | components/mine/goods-row */[__webpack_require__.e("common/vendor"), __webpack_require__.e("components/mine/goods-row")]).then(__webpack_require__.bind(null, /*! @/components/mine/goods-row.vue */ 581));};var searchAny = function searchAny() {return __webpack_require__.e(/*! import() | components/my-search/my-search */ "components/my-search/my-search").then(__webpack_require__.bind(null, /*! @/components/my-search/my-search.vue */ 588));};var _default = { components: { goodlist: goodlist, searchAny: searchAny }, data: function data() {return { latnng: {}, hasLocation: false, city: "", sunblind: false, one_cate: [{ name: "优惠券", url: "/pages/home/coupon/coupon", icon: "icon-icon_coupon" }, { name: "拼团", url: "/pages/home/assemble/assemble", icon: "icon-pintuan" }, { name: "限时抢", url: "/pages/home/flashSale/flashSale", icon: "icon-shijian" }, // {name:"置换",url:"/pages/home/displace/displace",icon:"icon-hezuo"},
