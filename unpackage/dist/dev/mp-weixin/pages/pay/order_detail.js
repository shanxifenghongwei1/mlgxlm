...
var _order_detail = _interopRequireDefault(__webpack_require__(/*! ./pages/pay/order_detail.vue */ 152));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _order_detail_vue_vue_type_template_id_fe9cd83e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./order_detail.vue?vue&type=template&id=fe9cd83e& */ 153);
/* harmony import */ var _order_detail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./order_detail.vue?vue&type=script&lang=js& */ 155);
...
/* harmony import */ var _order_detail_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./order_detail.vue?vue&type=style&index=0&lang=scss& */ 157);
...
var _default =
{
  ...
  methods: {
    ...
    assess: function assess(e) {
      this.sunblind = true;
      var url = "/pages/pay/assess?id=" + this.options.order_id;
    ...
    //确认收货
    mygoods_add: function mygoods_add() {var _this2 = this;
      this.global.request.post({
        url: 'up_status_add',
        data: {
          id: this.options.order_id,
  ...
  onShow: function onShow() {var _this3 = this;
    ...
    this.global.login_state.login_state().then(function (res) {
      if (res) {
        _this3.global.request.post({
          url: "order_detail",
          method: "GET",
          data: data,
          success: function success(res) {
            _this3.order_detail = res.data[0];
          } });
